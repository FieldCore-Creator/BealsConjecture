...
theorem equal_base_same_power_requires_gcd :
  ...
  -- brAIn's Computational Evidence:
  -- Tested 10,024 equations
  -- Found 9 solutions, ALL have gcd > 1
  ...
  -- 
  -- Attempting proof with brAIn's evidence:
  omega
...
lemma odd_square_mod_4 (A : ℕ) (h_odd : A % 2 = 1) :
  A^2 % 4 = 1 := by
  aesop  -- Requires: Expand (2k+1)^2 = 4k^2 + 4k + 1
